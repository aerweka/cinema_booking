...
import com.example.spring.entity.RolePath;
import com.example.spring.entity.User;
import com.example.spring.repository.OauthClientsRepository;
import com.example.spring.repository.RolePathRepository;
...
public class DatabaseSeeder implements ApplicationRunner {
    ...
    public void insertClients(String password) {
        for (String c: clients) {
            ...
            OauthClient oldClient = oauthClientsRepository.findOneByClientId(clientName);
            if (null == oldClient) {
                oldClient = new OauthClient();
            ...
            oauthClientsRepository.save(oldClient);
        }
    }
    ...
    public void insertUser(String password) {
        for (String userNames: users) {
            ...
            if (null == oldUser) {
                ...
                oldUser.setEmail("admin@admin.com");
